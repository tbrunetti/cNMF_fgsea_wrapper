...
# Step 1 - calulate your enrichments scores using fgsea (ONLY NEEDS TO BE DONE ONCE FOR A DATASET!)
...
# Step 2 - filter out your results
...
# Step 3 - plot results and get leading edge genes
